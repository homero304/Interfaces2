// Declarations for ParallelPort_button driver
// Copyright (C) 1999, 2000 by Walter Oney
// All rights reserved

#pragma once

#define DRIVERNAME "PARALLELPORT_BUTTON"				// for use in messages
#define LDRIVERNAME L"PARALLELPORT_BUTTON"				// for use in UNICODE string constants
#include "DevQueue.h"
