// Main program for ParallelPort_button driver
...
extern "C" NTSTATUS DriverEntry(IN PDRIVER_OBJECT DriverObject,
	...
	{							// DriverEntry
	KdPrint((DRIVERNAME " - Entering DriverEntry: DriverObject %X\n", DriverObject));
...
NTSTATUS AddDevice(IN PDRIVER_OBJECT DriverObject, IN PDEVICE_OBJECT pdo)
	...
	do
		...
		status = IoRegisterDeviceInterface(pdo, &GUID_DEVINTERFACE_PARALLELPORT_BUTTON, NULL, &pdx->ifname);
		if (!NT_SUCCESS(status))
