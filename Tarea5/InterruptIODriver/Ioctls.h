// IOCTLS.H -- IOCTL code definitions for InterruptIODriver driver
...
#define GET_PROGRAMMERS_NAMES CTL_CODE(FILE_DEVICE_UNKNOWN, 0x801, METHOD_BUFFERED, FILE_READ_ACCESS)
