// Declarations for ParallelPort_IO_Interrupt driver
// Copyright (C) 1999, 2000 by Walter Oney
// All rights reserved

#pragma once

#define DRIVERNAME "PARALLELPORT_IO_INTERRUPT"				// for use in messages
#define LDRIVERNAME L"PARALLELPORT_IO_INTERRUPT"				// for use in UNICODE string constants
#include "DevQueue.h"
