...
/** VARIABLES ******************************************************/
unsigned char OUTPacket[10];	//User application buffer for receiving and holding OUT packets sent from the host
unsigned char INPacket[10];		//User application buffer for sending IN packets to the host
#pragma udata
...
void UserInit(void)
{
    ...
    //i added the following code between // //
    TRISA = 0xFFFFFFFF;
    TRISD = 0x00000000;
    ...
    {   
        switch(OUTPacket[0])					//Data arrived, check what kind of command might be in the packet of data.
        {
            case 0x80: 
                ...
                break;
            case 0x81:  
                INPacket[0] = (unsigned char)LATA;
                if(!USBHandleBusy(USBGenericInHandle))		
	            {	
					USBGenericInHandle = USBGenWrite(1,(BYTE*)&INPacket[0],8);	
                }
                break;
        }
        
        USBGenericOutHandle = USBGenRead(2,(BYTE*)&OUTPacket[0],8);
    }
}//end ProcessIO
...
void USBCBInitEP(void)
{
    ...
    USBGenericOutHandle = USBGenRead(2,(BYTE*)&OUTPacket,8);
